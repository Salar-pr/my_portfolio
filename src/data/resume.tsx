...
export const DATA = {
  ...
  contact: {
    email: "salar_pr@outlook.com",
    tel: "+98 902 714 2836",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/Salar-pr",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/salar-rez",
        icon: Icons.linkedin,
  ...
  education: [
    {
      ...
      logoUrl: "https://rastapad.com/wp-content/uploads/2021/12/Rastapad_logo2.png",
      start: "2022",
      end: "2022",
    },
      ],
